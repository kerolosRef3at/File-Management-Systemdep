...
export const translations = {
    en: {
        ...
        dash_action_course_sub: "Register curriculum & code",
        dash_action_repo: "Programs",
        dash_action_repo_sub: "Browse programs & files",
    ...
    ar: {
        ...
        dash_weight: "الحجم",
        dash_quick_actions: "روابط سريعة ومباشرة",
        dash_action_upload: "رفع وثيقة جديدة",
        dash_action_upload_sub: "إضافة ملفات ومحاضرات للمستودع",
        dash_action_course: "إضافة مقرر دراسي",
        dash_action_course_sub: "تسجيل كورس وتحديد المنسق",
        dash_action_repo: "البرامج",
        ...
        logs_showing: "عرض",
        logs_of: "من",
        logs_stat_total: "إجمالي السجلات",
        logs_stat_auth: "جلسات الدخول",
        logs_stat_files: "نشاط الملفات",
        logs_stat_admin: "المستخدمين والأمان",
        logs_cat_all: "جميع الأنشطة",
        logs_cat_auth: "تسجيل الدخول",
        logs_cat_files: "الملفات والتخزين",
        logs_cat_courses: "المقررات",
        logs_cat_users: "إدارة المستخدمين",
        logs_select_action: "تصفية حسب الإجراء...",
        logs_all_actions_cat: "كل إجراءات القسم",
        logs_refresh: "تحديث",
        logs_live_trail: "مباشر",
        logs_details_title: "تفاصيل السجل",
